            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1.15fr 0.95fr 0.7fr 0.9fr", gap: 26, alignItems: "start" }}>
              <div>
                ...
                <div style={{ display: "grid", gap: 14, marginTop: 24 }}>
                  ...
                  <a href={`https://wa.me/${PHONE}`} target="_blank" rel="noreferrer" style={{ display: "flex", alignItems: "center", gap: 12, color: colors.text, fontSize: isMobile ? 15 : 17, textDecoration: "none" }}>
                    <MessageCircle size={18} color={colors.lime} />
                    WhatsApp
                  </a>
